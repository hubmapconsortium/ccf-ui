    ...
    if (key === 'ccf_annotations' && Array.isArray(value)) {
      ...
      if (value === 'https://hubmapconsortium.github.io/hubmap-ontology/ccf-entity-context.jsonld'
        ...
        return {
          ...
          'placement': { '@reverse': 'ccf:placement_for' },
          ...
          'source': { '@id': 'ccf:placement_for', '@type': '@id' },
          'target': { '@id': 'ccf:placement_relative_to', '@type': '@id' },
        ...
        return 'https://hubmapconsortium.github.io/ccf-ontology/ccf-context.jsonld';
      }
    }
    return value;
  });
