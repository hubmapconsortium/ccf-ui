...
export const ALL_ORGANS: OrganInfo[] = [
  { src: 'app:large_intestine', organ: 'Large Intestine', name: 'Large Intestine', hasSex: true, numResults: 0 },
  { src: 'app:heart', organ: 'Heart', name: 'Heart', hasSex: true, numResults: 0 },
  { src: 'app:kidney-left', organ: 'Kidney', name: 'Kidney, L', side: 'left', hasSex: true, numResults: 0 },
  { src: 'app:kidney-right', organ: 'Kidney', name: 'Kidney, R', side: 'right', hasSex: true, numResults: 0 },
  { src: 'app:spleen', organ: 'Spleen', name: 'Spleen', hasSex: true, numResults: 0 },
  { src: 'app:bladder', organ: 'Bladder', name: 'Bladder', disabled: true, hasSex: true, numResults: 0 },
  { src: 'app:brain', organ: 'Brain', name: 'Brain', disabled: true, hasSex: true, numResults: 0 },
  { src: 'app:liver', organ: 'Liver', name: 'Liver', disabled: true, hasSex: true, numResults: 0 },
  { src: 'app:lung-left', organ: 'Lung', name: 'Lung, L', disabled: true, side: 'left', hasSex: true, numResults: 0 },
  { src: 'app:lung-right', organ: 'Lung', name: 'Lung, R', disabled: true, side: 'right', hasSex: true, numResults: 0 },
  { src: 'app:lymph_nodes', organ: 'Lymph Nodes', name: 'Lymph Nodes', disabled: true, hasSex: true, numResults: 0 },
  ...
  { src: 'app:small_intestine', organ: 'Small Intestine', name: 'Small Intestine', disabled: true, hasSex: true, numResults: 0 },
  { src: 'app:stomach', organ: 'Stomach', name: 'Stomach', disabled: true, hasSex: true, numResults: 0 },
  { src: 'app:thymus', organ: 'Stomach', name: 'Thymus', disabled: true, hasSex: true, numResults: 0 }
];
