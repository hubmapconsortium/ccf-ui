...
import { CellTypeTreeModule } from './cell-type-tree.module';
...
describe('CellTypeTreeComponent', () => {
  ...
  let shallow: Shallow<CellTypeTreeComponent>;

  beforeEach(() => {
    shallow = new Shallow(CellTypeTreeComponent, CellTypeTreeModule);
  });
  ...
  it('should re-run the gradient display logic on a scroll event', async () => {
    ...
    const list = find('.ccf-cell-type-tree');
