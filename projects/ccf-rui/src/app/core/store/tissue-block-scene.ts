 ...
 */
export function getTissueBlockScene(node: SpatialEntity, sphere?: SpatialSearch): SpatialSceneNode[] {
  ...
  if (!sphere) {
    ...
    sphere = {
      ...sphere,
      radius: sphere.radius / 1000 / 2,
      x: sphere.x / 1000 - sceneWidth / 2,
      y: sphere.y / 1000 - sceneHeight / 2,
      z: sphere.z / 1000 - sceneDepth / 2
    };
  }
