...
import { addSubtree, createModel, linkChildren } from '../../services/ontology-search/ontology-search.service';
import { OntologyNode } from '../../models/ontology-node.model';
import { OntologyStateModel, OntologyState } from './ontology.state';
