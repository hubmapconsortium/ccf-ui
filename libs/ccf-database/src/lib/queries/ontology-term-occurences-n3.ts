...
function getSpatialEntityMapping(
  subjects: Set<string>,
  store: Store
...
function getAnatomicalStructureMapping(
  ids: Set<string>,
  store: Store
): Map<string, Set<string>> {
 ...
 */
export function getOntologyTermOccurences(
  ids: Set<string>,
  store: Store
 ...
 * @returns Ontology term counts.
 */
export function getBiomarkerTermOccurences(
  ids: Set<string>,
  store: Store
): Record<string, number> {
 ...
 * @returns Ontology term counts.
 */
export function getCellTypeTermOccurences(
  ids: Set<string>,
  store: Store
): Record<string, number> {
  const asTerm2entities = getAnatomicalStructureMapping(ids, store);
