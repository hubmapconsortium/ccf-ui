                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="modules-links"' : 'id="xs-modules-links"' }>
                            ...
                            <li class="link">
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-30c3c532f467fd90937a7e5858f05a40-1"' : 'data-target="#xs-components-links-module-AppModule-30c3c532f467fd90937a7e5858f05a40-1"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-30c3c532f467fd90937a7e5858f05a40-1"' :
                                            'id="xs-components-links-module-AppModule-30c3c532f467fd90937a7e5858f05a40-1"' }>
                                            <li class="link">
                            ...
                            <li class="link">
                                <a href="modules/LeftSidebarModule.html" data-type="entity-link">LeftSidebarModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-LeftSidebarModule-c3ccb7b5de4214bebb5ffa7eaa3be390"' : 'data-target="#xs-components-links-module-LeftSidebarModule-c3ccb7b5de4214bebb5ffa7eaa3be390"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-LeftSidebarModule-c3ccb7b5de4214bebb5ffa7eaa3be390"' :
                                            'id="xs-components-links-module-LeftSidebarModule-c3ccb7b5de4214bebb5ffa7eaa3be390"' }>
                                            <li class="link">
